...
public class CustomerServiceImp implements ICustomerService {
	...
	{
		boolean flag=false;
		Pattern vPAN=Pattern.compile("[0-9A-Z0-9]+");
	...
	{
		boolean flag=false;
		Pattern vAddress=Pattern.compile("[A-Za-z0-9,\\s]+");
	...
	@Override
	public boolean printTansaction(long accountNumber, int pin) throws AccountException
	{
